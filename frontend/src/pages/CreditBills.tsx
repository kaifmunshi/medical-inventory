...
// ✅ NEW (optional): small colored status chip
...
export default function CreditBills() {
  ...
  // ✅ NEW: show "Last Payment Mode" based on latest payment entry (if any)
            ...
            <Stack gap={2}>
              ...
              <Stack gap={0.5} sx={{ ml: 'auto', maxWidth: 420 }}>
                ...
                <Stack direction="row" alignItems="center" gap={1}>
                  <Typography>
                    Status:{' '}
                    <b style={{ verticalAlign: 'middle' }}>{detail.payment_status || '-'}</b>
                  </Typography>
                ...
                {/* ✅ NEW: keep original payment_mode, but also show last payment mode */}
                <Typography>
...
//         status: (b.payment_status || (pending > 0 ? 'UNPAID' : 'PAID')) as string,
//         mode: b.payment_mode || '',
//         itemsPreview: itemsPreview(b.items || []),
//       }
//     })
...
//                   Pending:{' '}
//                   <b>
//                     {money(Number(detail.total_amount || 0) - Number(detail.paid_amount || 0))}
//                   </b>
//                 </Typography>
//                 <Typography>
//                   Status: <b>{detail.payment_status || '-'}</b>
//                 </Typography>
//                 <Typography>
//                   Paid At: <b>{detail.paid_at || '-'}</b>
//                 </Typography>
